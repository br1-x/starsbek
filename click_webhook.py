...
def _build_pay_link(order_id: int, amount: int) -> str:
    ...
    Ishlaydigan format (do'stingiznikiga o'xshash):
    https://my.click.uz/services/pay?service_id=77133&merchant_id=41830&amount=22000.00&transaction_param=13156&return_url=https://t.me/StarsBazaar_Bot
    """
    return (
...
async def generate_pay_link(tg_id: int, amount: int):
    ...
    Do'stingizning ishlaydigan formatiga o'xshash link yaratadi.
    """
    if amount < 1000:
